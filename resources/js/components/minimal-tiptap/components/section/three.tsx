...
import { CheckIcon, ChevronDown, PaletteIcon } from 'lucide-react';
    ...
    return (
        <Popover>
            <PopoverTrigger asChild>
                <ToolbarButton tooltip="Text color" aria-label="Text color" className="gap-0" size={size} variant={variant}>
