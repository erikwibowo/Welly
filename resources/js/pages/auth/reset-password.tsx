...
export default function ResetPassword({ token, email }: ResetPasswordProps) {
    ...
    return (
        <AuthLayout title={useLang('text', 'reset_password')} description={useLang('text', 'reset_password_description')}>
            <Head title={useLang('text', 'reset_password')} />
